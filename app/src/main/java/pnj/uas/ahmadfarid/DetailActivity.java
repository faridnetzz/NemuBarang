...
import pnj.uas.ahmadfarid.utils.VolleyMultipartRequest;

public class DetailActivity extends AppCompatActivity {

    EditText edtNama, edtTlp, edtLokasi, edtImage;
        ...
        actionUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edtNama.getText().toString().length() > 0 &&
                        ...
                        edtLokasi.getText().toString().length() > 0) {
                    update();
                }
            }
        });
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "pnj.uas.ahmadfarid.fileprovider",
                        photoFile);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            edtTlp.setText(jsonObject.getString("tlp"));
                            edtLokasi.setText(jsonObject.getString("lokasi"));
